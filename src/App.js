  ...
  return (
    <div className="App">
      ...
      <nav className="navbar">
        ...
        {menuOpen && (
          <div className="menu-overlay" onClick={closeMenu} aria-label="Close menu" />
        )}
      </nav>
              ...
              {loading ? (
                ...
                <>
                  <h1 className="hero-title">
                    Hi, I’m <span className="blue">Justin Adame</span>
                  </h1>
                  <p className="hero-subtitle">
                    Frontend Developer focused on creating clean, professional,
                  ...
                  <div className="project-image-container">
                    {project.imageUrl ? (
                      <img
                        ...
                        onError={(e) => {
                          e.target.src = `https://via.placeholder.com/370x270/3b82f6/ffffff?text=${encodeURIComponent(
                            project.title
                          )}`;
                        }}
                      />
                  ...
                  <div className="project-simple-info">
                    ...
                    <div className="project-simple-tags">
                      {project.technologies.map((tech, tIdx) => (
                        <span key={tIdx} className="project-simple-tag">
                          {tech}
                        </span>
                      ))}
                    </div>
